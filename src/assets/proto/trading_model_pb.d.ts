...
export class Trade extends jspb.Message {
  ...
  setTickerName(value: string): void;
  ...
  getExecutedVolume(): string;
  setExecutedVolume(value: string): void;

  getExecutedPrice(): string;
  setExecutedPrice(value: string): void;

  getMatchedValue(): string;
  setMatchedValue(value: string): void;
...
export class Contract extends jspb.Message {
  ...
  getExchangeCode(): ExchangeCodeMap[keyof ExchangeCodeMap];
  setExchangeCode(value: ExchangeCodeMap[keyof ExchangeCodeMap]): void;
  ...
  getSettleQty(): string;
  setSettleQty(value: string): void;

  getOrderMode(): OrderModeMap[keyof OrderModeMap];
  setOrderMode(value: OrderModeMap[keyof OrderModeMap]): void;

  getCp(): CallPutMap[keyof CallPutMap];
  setCp(value: CallPutMap[keyof CallPutMap]): void;

  getStrikePrice(): string;
  setStrikePrice(value: string): void;

  getLimitPrice(): string;
  setLimitPrice(value: string): void;

  getSettlePrice(): string;
  setSettlePrice(value: string): void;

  getPositionPrice(): string;
  setPositionPrice(value: string): void;
...
export namespace Contract {
  export type AsObject = {
    orderId: string;
    symbolCode: string;
    exchangeCode: ExchangeCodeMap[keyof ExchangeCodeMap];
    orderType: OrderTypeMap[keyof OrderTypeMap];
    state: OrderStateMap[keyof OrderStateMap];
    qty: string;
    settleQty: string;
    orderMode: OrderModeMap[keyof OrderModeMap];
    cp: CallPutMap[keyof CallPutMap];
    strikePrice: string;
    limitPrice: string;
    settlePrice: string;
...
export interface CallPutMap {
  CALL_PUT_NONE: 0;
  PUT: 1;
  CALL: 2;
}

export const CallPut: CallPutMap;
