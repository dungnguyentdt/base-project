  ...
  proto.Quote.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        asksList: jspb.Message.toObjectList(msg.getAsksList(), proto.Band.toObject, includeInstance),
        bidsList: jspb.Message.toObjectList(msg.getBidsList(), proto.Band.toObject, includeInstance),
...
proto.Quote.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(4, f, proto.Band.serializeBinaryToWriter);
  }
  f = message.getBidsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(5, f, proto.Band.serializeBinaryToWriter);
  }
  f = message.getLow();
  if (f.length > 0) {
...
proto.Quote.prototype.getAsksList = function () {
  return /** @type{!Array<!proto.Band>} */ (jspb.Message.getRepeatedWrapperField(this, proto.Band, 4));
};
...
proto.Quote.prototype.getBidsList = function () {
  return /** @type{!Array<!proto.Band>} */ (jspb.Message.getRepeatedWrapperField(this, proto.Band, 5));
};
