  ...
  proto.Order.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        avgprice: jspb.Message.getFieldWithDefault(msg, 43, ""),
      };
...
proto.Order.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f !== 0.0) {
    writer.writeEnum(37, f);
  }
  f = message.getExternalState();
  if (f !== 0.0) {
    writer.writeEnum(38, f);
  }
...
/**
 * optional string avgPrice = 43;
 * @return {string}
 */
proto.Order.prototype.getAvgprice = function () {
 ...
 * @return {!proto.Order} returns this
 */
proto.Order.prototype.setAvgprice = function (value) {
