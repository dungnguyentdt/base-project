...
proto.NewOrderSingleRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getOrder();
  if (f != null) {
    writer.writeMessage(1, f, trading_model_pb.Order.serializeBinaryToWriter);
  }
...
proto.NewOrderSingleRequest.prototype.getOrder = function () {
  return /** @type{?proto.Order} */ (jspb.Message.getWrapperField(this, trading_model_pb.Order, 1));
};
...
proto.NewOrderMultiRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, trading_model_pb.Order.serializeBinaryToWriter);
  }
  f = message.getSecretKey();
  if (f.length > 0) {
    writer.writeString(2, f);
...
proto.NewOrderMultiRequest.prototype.getOrderList = function () {
  return /** @type{!Array<!proto.Order>} */ (jspb.Message.getRepeatedWrapperField(this, trading_model_pb.Order, 1));
};
...
proto.TradeEvent.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, trading_model_pb.Trade.serializeBinaryToWriter);
  }
};
...
proto.TradeEvent.prototype.getTradeList = function () {
  return /** @type{!Array<!proto.Trade>} */ (jspb.Message.getRepeatedWrapperField(this, trading_model_pb.Trade, 1));
};
