...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.GetLastQuotesResponse.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        quotesList: jspb.Message.toObjectList(msg.getQuotesList(), pricing_model_pb.Quote.toObject, includeInstance),
      };
...
proto.GetLastQuotesResponse.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, pricing_model_pb.Quote.serializeBinaryToWriter);
  }
};
...
proto.GetLastQuotesResponse.prototype.getQuotesList = function () {
  return /** @type{!Array<!proto.Quote>} */ (jspb.Message.getRepeatedWrapperField(this, pricing_model_pb.Quote, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.QuoteEvent.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        quoteList: jspb.Message.toObjectList(msg.getQuoteList(), pricing_model_pb.Quote.toObject, includeInstance),
      };
...
proto.ChartRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, pricing_model_pb.Chart.serializeBinaryToWriter);
  }
};
...
proto.ChartRequest.prototype.getChartData = function () {
  return /** @type{?proto.Chart} */ (jspb.Message.getWrapperField(this, pricing_model_pb.Chart, 2));
};
