  ...
  proto.AdminSettings.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        sessionSettingsList: jspb.Message.toObjectList(
          msg.getSessionSettingsList(),
          proto.SessionSettings.toObject,
          includeInstance,
        ),
        holidaySettingsList: jspb.Message.toObjectList(
          msg.getHolidaySettingsList(),
          proto.Holiday.toObject,
          includeInstance,
        ),
      };
...
proto.AdminSettings.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(3, f, proto.SessionSettings.serializeBinaryToWriter);
  }
  f = message.getHolidaySettingsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(4, f, proto.Holiday.serializeBinaryToWriter);
  }
};
...
proto.AdminSettings.prototype.getHolidaySettingsList = function () {
  return /** @type{!Array<!proto.Holiday>} */ (jspb.Message.getRepeatedWrapperField(this, proto.Holiday, 4));
};
  ...
  proto.MarketSettings.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        mdTimeList: jspb.Message.toObjectList(msg.getMdTimeList(), proto.SessionSettings.toObject, includeInstance),
        tradingTimeList: jspb.Message.toObjectList(
          msg.getTradingTimeList(),
          proto.SessionSettings.toObject,
          includeInstance,
        ),
      };
...
proto.MarketSettings.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(4, f, proto.SessionSettings.serializeBinaryToWriter);
  }
  f = message.getTradingTimeList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(5, f, proto.SessionSettings.serializeBinaryToWriter);
  }
};
